...
def get_tweets(listname, listcollection):
    for each_list in the_lists.values():
        for each_json_tweet in each_list:
            if each_list == the_lists[listname]:
...
make_txt('gaming', gaming_tweets), make_txt('gurus', gurus_tweets), make_txt('eth', eth_tweets), make_txt('econ', econ_tweets),
make_txt('ai', ai_tweets), make_txt('btc', btc_tweets), make_txt('space', space_tweets), make_txt('systems', systems_tweets)
